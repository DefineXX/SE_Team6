...
Extensions1: Step2 이후, 관리자는 대여소 리스트에서 특정 대여소의 상세 정보를 조회할 수 있다.  
Extensions2: Step2 이후, 관리자는 대여소 리스트에서 특정 대여소를 선택하여 삭제할 수 있다.
...
Extensions1: Step2 이후, 관리자는 자전거 리스트에서 특정 자전거의 상세 정보를 조회할 수 있다.  
Extensions2: Step2 이후, 관리자는 자전거 리스트에서 특정 자전거를 선택하여 삭제할 수 있다.
...
| 3. 기간별 자전거 대여 금액 조회 요청 |  |
|  | 4. 선택 기간에 따른 자전거 대여 금액 출력 |
| 5. 기간별 자전거 대여 횟수 조회 요청 |  |
|  | 6. 선택 기간에 따른 자전거 대여 횟수 출력 |

Extensions1 : Step1 이전, 관리자는 자전거 대여 기록의 정렬 기준(시간, 지역)을 선택할 수 있다.  
Extensions2: Step3와 5 이전, 관리자는 조회 기간(최근 1주일, 1개월, 1년)을 선택할 수 있다.
