...
| No. | Requirement | Use Case(s) |
| --- | ----------- | ----------- |
| 1.  | 관리자는 대여소 정보를 등록, 조회 및 삭제할 수 있다. 입력 정보는 이름, 위치, 보관 가능 수량, 운영 시간이다. | 대여소 등록/조회/삭제 |
| 2.  | 관리자는 등록된 대여소 리스트에서 원하는 항목을 선택하여 상세정보를 확인하거나 삭제할 수 있다. | 대여소 상세 확인 및 삭제 |
| 3.  | 관리자는 자전거 정보를 등록, 조회 및 삭제할 수 있다. 입력 정보는 자전거 ID, 제품명, 유형(일반/전기), 소속 대여소, 상태(사용 가능/수리 중) 등이다. | 자전거 등록/조회/삭제 |
| 4.  | 관리자는 등록된 자전거 리스트에서 특정 항목을 선택하여 상세정보를 확인하거나 삭제할 수 있다. | 자전거 상세 확인 및 삭제 |
| 5.  | 관리자는 자전거 대여 정보를 반납 시간 기준으로 최근순으로 조회할 수 있다. | 최근 대여 기록 조회 |
| 6.  | 관리자는 대여 정보를 지역별 기준으로 정렬하여 조회할 수 있다. | 지역별 대여 기록 정렬 |
| 7.  | 관리자는 최근 1주일, 1개월, 1년 단위로 대여 금액 및 대여 횟수를 통계로 조회할 수 있다. | 기간별 대여 통계 조회 |
